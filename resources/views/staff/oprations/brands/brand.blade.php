            ...
            @endif
                ...
                <div class="row">
                            ...
                            <tbody>
                                @foreach ($members as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{asset('/admin/brandEdit/'.$item->id)}}"><i title="Edit" class="fa c-icon fa-pencil"></i></a>
                                            <i title="Delete" class="c-icon fa fa-trash" onclick="del_brand({{$item->id}})" ></i>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                    ...
                    <div class="col-md-6">
                        ...
                        <form action="{{route('admin.brandstore')}}" class="d-flex justify-content-center mb-10 mt-30" method="POST">

  ...
  <div class="modal-content p-1" style="width:100%;">
    <div class="modal-header d-flex justify-content-between p-1">
      <div>
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          <li class="nav-item"> 
            <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pro_image" role="tab"
                aria-controls="pills-home" aria-selected="true">Select</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pro_image_drop" role="tab"
    ...
    <div class="modal-body">
      ...
      <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pro_image" role="tabpanel" aria-labelledby="pills-home-tab">
          <div class="row">
              @foreach($images as $image)
              <div class="col-md-2 pt-2">
                <div class="card" onclick="Product_Image(`{{$image['id']}}`)">
        ...
        <div class="tab-pane fade" id="pro_image_drop" role="tabpanel" aria-labelledby="pills-profile-tab">
          <div class="row">
            <div class="col-md-12">
                <div class="card">
    ...
    <div class="modal-footer product_links d-flex justify-content-between">
      {{ $images->links()}}

			...
			<div class="container">
				...
				<nav class="nav-menu">
					<ul class="nav-list">
						...
						<li id ='service'><a href="{{asset('/service')}}">Services</a></li>
						<li id ='shop'><a href="{{asset('/shop')}}">Shop </a></li>
						<li id ='gallery'><a href="{{asset('/gallery')}}">Gallery</a></li>	
						<li id ='about'><a href="{{asset('/about')}}">About Us</a></li>
						<li id ='contact'><a href="{{asset('/contact')}}">Contacts</a></li>
					</ul>
				</nav>
			</div>
		</div>

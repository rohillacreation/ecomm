            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-3 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div onclick="product_id({{$product['id']}})" class="col-span-1 border border-gray-400 rounded cursor-pointer">
                            <img class="h-48 flex items-center" src="{{asset('uploads/gallery/'.$product['location'])}}" alt="Card image cap">
                            <p>{{$product->name}}</p>
                        </div>

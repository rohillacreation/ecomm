...
<div class="main-container multivendors" id="container">
        ...
        <div id="content" class="main-content">
            ...
            @endif
                ...
                <form class="row" id="create_product_form" action="{{ route('admin.update_product') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="pdt-infor">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="tags[]" data-role="tagsinput" class="form-control" value="@foreach($tags as $value){{$value->name}},@endforeach"required>
                        ...
                        <div class="pdt-image">
                            ...
                            <div class="thum_image_previwe row">
                                ...
                                @if(count($main_ex_images) > 0 )

                                    @foreach($main_ex_images as $value)

                                        <div class="remove_thum_img">
                                        @foreach($value->gallery as $img)

                                            <img width="100px" height="100px" src="{{asset('uploads/gallery/'.$img['location'])}}" alt="pro img">
                                            <input type="hidden" name="product_thum_img" value="{{$img->id}}">
                                ...
                                @else
                                    ...
                                    <input type="hidden" name="product_thum_img" value="">
                            ...
                            <div class="pro_image_previwe row">
                                @if(count($ex_images) > 0 )
                                    ...
                                    @foreach($ex_images as $value)

                                        <div class="pro_image_previwe">
                                            @foreach($value->gallery as $img)
                                            <img width="100px" height="100px" src="{{asset('uploads/gallery/'.$img['location'])}}" alt="pro img">
                                            <input type="hidden" name="product_img[]" value="{{$img->id}}">
                                            @endforeach
                        ...
                        <div class="pdt-price">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="unit_type" class="form-control" id="slug" value="{{$product->unit_type}}" placeholder="Unit (e.g. KG, Pc etc)">
                                </div>
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" type="number" name="quantity" step="1" value="{{$product->quantity}}" min="0" class="form-control">
                                </div>
                            ...
                            <div id="show_list_variant">
                                ...
                                <table class="table table-bordered custab mt-5">
                                    ...
                                    <tr>
                                        <td class="text-left" style="cursor:pointer;" class="clk-rw collapsed" id="item-id" data-toggle="collapse" href="#{{$value->name}}" aria-expanded="false" aria-controls="collapseExample">{{$value->name}}<input name= "variant[]" type="hidden" value="{{$value->name}}"/></div></td>
                                        <td class="text-left"><input name= "var_price[]" type="number" min="0.01" value="{{$value->price}}" required class="form-control" /></td>
                                    </tr>

                                    <tr>
                                        <td colspan="3" class="collapse-table collapse" id="{{$value->name}}" style="">
                                            <table class="table custab">
                                                <tbody>
                                                    <tr>
                                                        <th style="width: 100px;">SKU</th>
                                                        <td colspan="5" style="text-align: left;"><input name= "var_sku[]" type="text" value="{{$value->sku}}" class="form-control"/></th>
                            
                                                    </tr>
                                                    <tr>
                                                        <th style="width: 100px;">Quantity</td>
                                                        <td colspan="5" style="text-align: left;"><input name= "var_qty[]" type="number" step="1" min="0" value="{{$value->quantity}}" class="form-control" required/></td>
                            
                                                    </tr>
                                                    <tr>
                                                        <th style="width: 100px;">Image</td>
                                                        <td colspan="5" style="text-align: left;">
                                                            <button type="button" value="{{$value->name}}" name="picture_{{$value->name}}" class="btn btn-warning btn-sm my-1 Variant_choosen" data-target="#Variant_Image_Modal" data-toggle="modal">Borwse</button>
                                                            <div id="{{$value->name}}"><input type="hidden" name="vartion_selected_images[]" value=""></div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
